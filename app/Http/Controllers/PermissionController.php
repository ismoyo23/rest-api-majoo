...
class PermissionController extends Controller
{
    ...
    public function index(){
        try
        {
            ...
            return response()->json(['headers' => ["process_time" => microtime(), "messages"=> "Your request has been processed successfully"], 'data' => $response])->setStatusCode(200);
        }

        catch(Exception $e)
        {
            // This doesn't work. This code is never called because Laravel 
            return $this->setStatusCode(505)->respondWithError("internal server error");
        }
    ...
    public function update(Request $request,$id){
        ...
        try
        {
            ...
            return response()->json(['headers' => ["process_time" => intval(microtime(true)) ,"messages"=> "Your request has been processed successfully"], 'data' => $request])->setStatusCode(201);
        }
        catch(Exception $e)
        {
            return $this->setStatusCode(505)->respondWithError("internal server error");
